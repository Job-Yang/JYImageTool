#
#  Be sure to run `pod spec lint YTZImageComparison.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "1.1"
  s.summary      = "YTZImageComparison is a image compariosn recognition framework."
  ...
  s.author             = { "杨权" => "578093143@qq.com" }
  # Or just: s.author    = "杨权"
  # s.authors            = { "杨权" => "578093143@qq.com" }
  ...
  s.source       = { :git => "https://github.com/Job-Yang/YTZImageComparison.git", :tag => "1.1" }
  ...
  s.source_files  = "YTZImageComparison/*"
